...
def main(input_path, output_path, n_samples, n_ai_samples, n_human_samples, ollama_url):
    text_models = [OllamaModel(model_name='llama2:13b', base_url=ollama_url, in_the_middle_generation=True),
                   ...
                   OllamaModel(model_name='codellama:13b', base_url=ollama_url),
                   ...
                   OllamaModel(model_name='qwen2:7b-text-q4_0', base_url=ollama_url),
                   ...
                   OllamaModel(model_name='yi:34b', base_url=ollama_url),
                   OllamaModel(model_name='zephyr:7b-beta', base_url=ollama_url),
                   OllamaModel(model_name='openchat:7b', base_url=ollama_url),
                   OllamaModel(model_name='openhermes', base_url=ollama_url),
                   ]
